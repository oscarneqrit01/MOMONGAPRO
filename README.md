...
- **Vista en vivo**: botón **"Vista en vivo"** en cada cuenta: ves su navegador en tiempo real dentro del panel y puedes hacer clic y escribir directamente (como si estuvieras en esa PC).
